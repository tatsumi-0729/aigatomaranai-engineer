...
staticファクトリについては以前から知っていましたが、個人的には、コンストラクタの種類や引数が多いと分かりずらく、実装ミスに繋がる可能性が軽減される点や、オブジェクトの生成が一度で済むことによるパフォーマンスの向上、結合度が下がる点などなど…、様々に魅力に感じているので、staticファクトリを推していきたいところです。
